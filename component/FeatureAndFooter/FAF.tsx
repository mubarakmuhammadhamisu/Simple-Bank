...
const FAF = () => {
  return (
    <div>
      <MaxWidth className='max-w-6xl rounded-2xl pt-0 px-4 sm:px-12'>
      ...
      <h2 className='text-lg font-bold pl-4 sm:pl-2 mt-5'>Financial Stats</h2>
      <footer className='w-full bg-gradient-to-r from-blue-600 to-blue-900 rounded-xl shadow-2xl
        min-h-40 flex-col flex justify-center items-center px-4 py-8 text-center'>
        <h2 className='text-base sm:text-lg font-bold text-white'>Ready to take control of your finances</h2>
        <div className='flex mt-7 gap-4 items-center'>
          <Link href='#' className='text-white text-sm'>Privacy</Link>
